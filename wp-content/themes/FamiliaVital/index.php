     ...
     <main>
          <aside>
               <div class="banner_1 d-none d-sm-none d-md-none d-lg-block">
                    <a href="#"><img src="../resources/img/varias/bannerChat.jpg" alt="chatVirtual" class="rounded"></a>
                    <a href="#"><img src="../resources/img/varias/bannerChat2.jpg" alt="chatWhatsapp" class="rounded"></a>
               </div>
               <div class="banner_2 d-block d-sm-block d-md-block d-lg-none">
                    <a href="#"><img src="../resources/img/varias/bannerChatH.jpg" alt="chatVirtual" class=""></a>
                    <a href="#"><img src="../resources/img/varias/bannerChatH2.jpg" alt="chatWhatsapp" class=""></a>
               </div>
          </aside>
          <!-- section carrusel -->
